...
class FollowersT extends StatefulWidget {
  final int index;
  const FollowersT({Key? key , required this.index}) : super(key: key);

  @override
  State<FollowersT> createState() => _Followers();
}

class _Followers extends State<FollowersT> {
  Future<List<dynamic>> loaddata() async {
    ...
    final response = await http.get(
      Uri.parse('${dotenv.env['API_URL']}/api/get_follow_users/${widget.index}'),
      headers: {
