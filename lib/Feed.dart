                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Column(children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (snapshot.data[index]['user_type'] ==
                                      "google" ||
                        ...
                        if(snapshot.data[index]['user_id'] != UserId) Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (snapshot.data[index]['comment_count'] > 0)
                                Container(
                                  child: Text(
                                    "View ${snapshot.data[index]['comment_count']} Comments",
                                    style: TextStyle(
                                      fontSize: 15,
                                      fontFamily: "SFPRO regular",
                                    ),
...
class Show_image extends StatefulWidget {
  final String imgUrl;
  const Show_image({Key? key, required this.imgUrl}) : super(key: key);
