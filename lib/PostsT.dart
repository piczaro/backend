...
class PostsT extends StatefulWidget {
  final int index;
  const PostsT({Key? key , required this.index }) : super(key: key);

  @override
  State<PostsT> createState() => _Posts();
}

class _Posts extends State<PostsT> {
  int? postcount ;
  Future<List<dynamic>> loaddata() async {
    ...
    final response = await http.get(
      Uri.parse(
          '${dotenv.env['API_URL']}/api/participant_image_details/${widget.index}'),
      headers: {
